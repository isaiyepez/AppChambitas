...
namespace AppChambitasV1.Backend.Controllers
{
    public class TecnicoesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Tecn_ID,Tecn_Nombre,Tecn_Correo,Tecn_Contrasenia,Tecn_Domicilio,Tecn_Promedio,Tecn_Activo,Tecn_Imagen,Tecn_FechaHora,Tecn_ModificadoPor")] Tecnico tecnico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Tecn_ID,Tecn_Nombre,Tecn_Correo,Tecn_Contrasenia,Tecn_Domicilio,Tecn_Promedio,Tecn_Activo,Tecn_Imagen,Tecn_FechaHora,Tecn_ModificadoPor")] Tecnico tecnico)
        {
            if (ModelState.IsValid)
            {
